  ...
  if (!upload) {
    return (
      <div className="flex flex-col items-center justify-center h-full">
        ...
        <p className="text-muted-foreground mb-6">The requested video upload could not be found.</p>
            ...
            <Card className="p-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="font-medium ml-6 text-sm break-all">{upload.filename}</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-foreground ml-6">{upload.claim.claimant.fullName}</p>
                  <p className="text-muted-foreground ml-6 text-sm">
                    {upload.claim.claimant.phoneNumber}
                  </p>
                </div>
              </div>
            </Card>
