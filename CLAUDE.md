...
- **GPU host integration:** `docs/GPU_HOST_INTEGRATION.md` — the handshake between the repo and the GPU desktop. Read this before touching `OllamaGpuLlmProvider`: it calls a `/v3` API that does not exist on that host
