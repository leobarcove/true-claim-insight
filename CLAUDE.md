...
- **Claimant Telegram channel status:** `docs/TELEGRAM_CHANNEL_STATUS.md` — what works, what is pending and why, per tier. Read it before demoing or extending the conversational intake; the roadmap does not answer "can a claimant actually use this yet?" at the level of one channel
