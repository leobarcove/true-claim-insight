...
echo "  4. Create a STAGING-ONLY Telegram bot with @BotFather and paste its"
echo "     token into TELEGRAM_BOT_TOKEN. Never the development bot's token:"
echo "     two pollers on one token each receive half the messages."
