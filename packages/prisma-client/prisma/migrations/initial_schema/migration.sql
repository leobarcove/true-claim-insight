...
-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('ADJUSTER', 'FIRM_ADMIN', 'CLAIMANT', 'SUPER_ADMIN', 'SIU_INVESTIGATOR', 'COMPLIANCE_OFFICER', 'SUPPORT_DESK', 'SHARIAH_REVIEWER');
...
-- CreateEnum
CREATE TYPE "ActorType" AS ENUM ('CLAIMANT', 'ADJUSTER', 'FIRM_ADMIN', 'SUPER_ADMIN', 'SIU_INVESTIGATOR', 'COMPLIANCE_OFFICER', 'SUPPORT_DESK', 'SHARIAH_REVIEWER', 'SYSTEM');
