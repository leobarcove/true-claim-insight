        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    console.log('User tenantId:', user === null || user === void 0 ? void 0 : user.tenantId);
                    return [4 /*yield*/, prisma.claim.findUnique({
                            where: { id: '48f51d46-0a6f-4abf-abd5-5c7563018c0e' },
                            include: { adjuster: { select: { tenantId: true } } }
                        })];
                case 2:
                    claim = _c.sent();
                    console.log('Claim adjuster tenantId:', (_a = claim === null || claim === void 0 ? void 0 : claim.adjuster) === null || _a === void 0 ? void 0 : _a.tenantId);
                    console.log('Claim insurerTenantId:', claim === null || claim === void 0 ? void 0 : claim.insurerTenantId);
                    // If mismatch, we need to either:
                    // 1. Update the claim's adjuster tenant
                    // 2. Or update the user's tenant
                    if ((user === null || user === void 0 ? void 0 : user.tenantId) && ((_b = claim === null || claim === void 0 ? void 0 : claim.adjuster) === null || _b === void 0 ? void 0 : _b.tenantId) !== user.tenantId) {
